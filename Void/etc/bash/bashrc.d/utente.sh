#  ___________________________  Bashrc  ___________________________
#
# _____ Interattiva
case $- in
    *i*) ;;
...
#
#  ___________________________  Direttive  ___________________________
export GPG_TTY=$(tty)
export TERM="xterm"
export EDITOR="nano"
...
#
#  ___________________________  Colori Ansi  ___________________________
case "$TERM" in
...
#  ___________________________  Shell  Utente  ___________________________
#
#
...
#
#
# ___________________________   Fine  _____________________________
